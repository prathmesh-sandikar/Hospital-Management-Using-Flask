...
def dashboard():
    ...
    try:
        query = cursor.execute(
            "INSERT INTO HOSPITAL(name,mobile,age,address,DOB,place,pincode)VALUES('" + getname + "','" + getmobile + "','" + getage + "','" + getaddress + "','" + getDOB + "','" + getplace + "','" + getpincode + "')")
        print(query)
        conn.commit()
...
def vieupdate():
    ...
    try:
        cursor.execute(
            "UPDATE HOSPITAL SET name='" + getname + "',mobile='" + getmobile + "',age='" + getage + "',address='" + getaddress + "',DOB='" + getDOB + "',place='" + getplace + "',pincode='" + getpincode + "'WHERE mobile=" + getmobile)
        conn.commit()
        return redirect("/viewall")
    except Exception as e:
        print(e)
